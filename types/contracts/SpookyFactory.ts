...
export interface SpookyFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_PAIR_HASH"
      | "allPairs"
...
export interface SpookyFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SpookyFactory;
  waitForDeployment(): Promise<this>;

  interface: SpookyFactoryInterface;
