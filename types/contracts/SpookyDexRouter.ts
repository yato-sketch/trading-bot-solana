...
export interface SpookyDexRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface SpookyDexRouter extends BaseContract {
  connect(runner?: ContractRunner | null): SpookyDexRouter;
  waitForDeployment(): Promise<this>;

  interface: SpookyDexRouterInterface;
